...
\hfill{[2008]}
\begin{enumerate}
\text Neither S nor T is an equivalence relation on R                                        
                                
\text Both S and T are equivalence relation on R   
                                
\text S is an equivalence relation on R but T is not
\text T is an equivalence relation on R but S is not
...
\text either on the real axis or on a circle not passing through the origin
                                   
                              
\text  on a circle with centre at the origin
                             
\text either on the real axis or on a circle not passing through the origin                                                                  
\text on imaginary axis
...
\text is strictly greater than $\frac{5}{2}$       

\text is strictly greater than $\frac{3}{2}$ but less than $\frac{5}{2}$
\text is equal to $\frac{5}{2}$

\text lies in the interval $\brak{1,2}$
...
\text circle of radius $\sqrt2$

\text straight line parallel to x-axis

\text  straight line parallel to y-axis
...
\text straight line whose slope is 1                
                             
\text circle whose radius is 1                      

\text circle whose radius is $\sqrt2$
